...
import healthpal from "../../assets/healthpal.png";
import bamm from "../../assets/bamm.png";
...
export default function ProjectList() {
  ...
  const projects = [
    ...
    },
    {
      ...
      githubLink: "https://github.com/andrea1234321/level-up",
    },
    {
      name: "BlackJack",
      img: blackjack,
  ...
  return (
    <>
      ...
      <div
        className={`flex overflow-x-auto sm:justify-center ${styles.paginationContainer}`}
      >
        <Pagination
